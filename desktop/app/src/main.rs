    ...
    Application::new()
        ...
        .run(|cx: &mut App| {
            ...
            let fonts = vec![
                ...
                Cow::Borrowed(include_bytes!("../font/SF-Pro-Text-Heavy.otf") as &[u8]),
                ...
                Cow::Borrowed(include_bytes!("../font/SF-Pro-Display-Semibold.otf") as &[u8]),
                Cow::Borrowed(include_bytes!("../font/SF-Pro-Display-Bold.otf") as &[u8]),
                Cow::Borrowed(include_bytes!("../font/SF-Pro-Display-Heavy.otf") as &[u8]),
                Cow::Borrowed(include_bytes!("../font/SF-Mono-Regular.otf") as &[u8]),
                Cow::Borrowed(include_bytes!("../font/SF-Mono-RegularItalic.otf") as &[u8]),
