...
pub fn theme_light() -> Theme {
    let mut theme = theme_catppuccin_latte();
    theme.name = "Light";
    theme.bg_modal = rgb(0xf8f9fc);
    theme.border_overlay = rgba(0x4c4f6940);
    theme.text_dim = rgba(0x5c5f77c8);
    theme.text_muted = rgba(0x5c5f7798);
    theme.text_soft = rgba(0x4c4f69c0);
    theme.text_placeholder = rgba(0x6c6f8570);
    theme.row_hover = rgba(0x4c4f6920);
    theme.row_hover_strong = rgba(0x4c4f692c);
    theme.button_bg = rgba(0x4c4f6920);
    theme.button_hover = rgba(0x4c4f6930);
    theme.divider_tiny = rgba(0x4c4f6916);
    theme.checkbox_border_off = rgba(0x6c6f85d0);
    theme.checkbox_fill_off = rgba(0xffffffd0);
    theme
}
